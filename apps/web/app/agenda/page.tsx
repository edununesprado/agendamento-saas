      ...
      <div className="flex min-h-screen">
        ...
        <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col bg-zinc-950 text-white md:flex">
          ...
          <nav className="flex-1 space-y-2 p-4">
            ...
            <Link
              href="/dashboard"
              className="block w-full rounded-lg px-4 py-3 text-sm text-zinc-300 hover:bg-zinc-900"
            >
              Dashboard
            </Link>
            ...
            <Link
              href="/agenda"
              className="block w-full rounded-lg bg-zinc-800 px-4 py-3 text-sm font-medium text-white"
            >
              Agenda
            </Link>
